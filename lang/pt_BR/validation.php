...
return [
    ...
    | pela classe validadora. Algumas regras têm múltiplas versões, como as
    | regras de tamanho. Fique à vontade para ajustar cada uma delas.
    |
    */
    ...
    'contains' => 'O campo :attribute deve conter um valor obrigatório.',
    ...
    |--------------------------------------------------------------------------
    |
    | Aqui você pode especificar mensagens personalizadas usando a convenção
    | "attribute.rule". Isso permite criar mensagens únicas para atributos.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | As linhas a seguir são usadas para substituir o nome do atributo por algo
